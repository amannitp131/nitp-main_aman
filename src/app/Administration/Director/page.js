...
const page = () => {
    return (
        <div className="w-full max-w-7xl mx-auto px-4 md:px-6 pt-12 md:py-16 text-black text-justify">
            <div className="grid md:grid-cols-[200px_1fr] gp-8 md:gap-12">
                <div className="flex flex-col items-center md:items-start gap-4">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <a href="mailto:director@nitp.ac.in"><span className="text-neutral-700">director@nitp.ac.in</span></a>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span className="text-neutral-700">NIT Patna</span>
                        </div>
                    </div>
                    <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-gray-900 focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
                        <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white hover:dark:bg-red-800 rounded-md group-hover:bg-opacity-0">
                            <a href="https://drive.google.com/file/d/1Z4t3povLq2PqdWXaGeJ2g55ge9PbG_Jy/view?sz=w320">View CV</a>
                        </span>
                    </button>
                </div>
                <div className="space-y-6">
                    <div className="space-y-4 border-2 border-amber-800 p-6 backdrop-blur-sm rounded-lg">
                        <h2 className="text-2xl font-medium text-[#a01d0c] z-50">About</h2>
                    ...
                    <div className="space-y-4 border-2 border-amber-800 p-6 backdrop-blur-sm rounded-lg">
                        <h2 className="text-2xl font-medium text-[#a01d0c]">Director's Message</h2>
                        <p className="text-muted-foreground">
                    ...
                    <div className="space-y-4 border-2 border-amber-800 p-6 backdrop-blur-sm rounded-lg">
                        <h2 className="text-2xl font-medium text-[#a01d0c]">Past Administrative Responsibilities</h2>
