        ...
        <div className="flex justify-center items-center py-10">
            <div className="relative bg-white shadow-lg rounded-xl overflow-hidden w-full max-w-md p-6">
                ...
                <div className="relative flex flex-col items-center text-center">
                    ...
                    <h2 className="mt-2 text-xl font-semibold text-gray-800">Smt. Droupadi Murmu</h2>
                    <p className="mt-1 text-sm text-gray-600">The President of India is the ex officio visitor of the Institute.</p>
                    <div className="mt-5">
                        <a
