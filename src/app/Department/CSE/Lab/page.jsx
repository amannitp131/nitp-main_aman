        ...
        <div className="w-full px-5 xs:px-0 md:w-[90%] lg:w-[80%] mx-auto">
          ...
          <div className="w-full mt-4">
            {labsData.map((lab, index) => (
              <div
                key={index}
                className="mb-12 flex flex-col lg:flex-row items-center lg:items-start mx-auto text-center lg:text-left max-w-4xl"
              >
                <div className="lg:w-2/3">
                  <p className="text-red-900 font-bold text-2xl mb-4">
                    {lab.name}:
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed px-6 lg:px-0">
                    {lab.description}
                  </p>
                </div>
