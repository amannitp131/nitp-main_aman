      ...
      <div className="w-full px-5 xs:px-0 md:w-[90%] lg:w-[80%] mx-auto">
        ...
        <p className="text-justify mt-2">
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              Communications: Communicate effectively on complex engineering
        ...
        <p className="text-justify mt-2">
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Engage in requirement analysis, designing, implementation,
              testing, deployment, and/or maintaining of software systems in the
              domain of computer science & engineering and allied fields.
            </li>
            <li>
              Solve socially relevant challenges using computer science and
              engineering expertise, and/or pursue higher education and
              research.
            </li>
            <li>
              Work productively in a team and as an individual in
              interdisciplinary projects in industry/academia setup.
            </li>
            <li>
              Participate in lifelong learning and career advancement, as well
