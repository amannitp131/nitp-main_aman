...
export default function PeopleList() {
  ...
  return (
    <div className="flex flex-col p-4 m-4">
      <div key="People">
        <h6 className=" text-black text-[25px]" style={{ fontWeight: 750 }}>Head</h6>
        ...
        <div key="Administration">
          <h6 className="text-black text-[25px]" style={{ fontWeight: 750 }}>Officers</h6>
          <div className="grid md:grid-cols-1 gap-1">
            {officer.map((faculty) => (
              <PeopleCard
                key={faculty.id}
        ...
        <div key="Others">
          <h6 className=" text-black text-[25px]" style={{ fontWeight: 750 }}>Others</h6>
          <div className="grid md:grid-cols-1 gap-1">
            {other.map((faculty) => (
              <PeopleCard
                key={faculty.id}
