    ...
    <div className="flex flex-col">
      ...
      <div className="w-full h-fit px-2 py-2 bg-white flex flex-col gap-2 sm:gap-3">
        <div className="w-full h-[50vw] rounded-lg overflow-hidden">
          <img alt="img" className="w-full h-full object-cover" src={images[0]} />
        </div>
        ...
        <div className="w-full flex flex-col sm:flex-row gap-2 sm:gap-3">
          <div className="flex w-full sm:w-[33%] flex-row sm:flex-col gap-2 sm:gap-3">
            <div className="w-[55vw] sm:w-full h-48 sm:h-80 rounded-lg overflow-hidden">
              <img alt="img" src={images[1]} className="w-full h-full object-cover" />
            </div>
            <div className="w-[45vw] sm:w-full h-48 sm:h-64 rounded-lg overflow-hidden">
              <img alt="img" src={images[2]} className="w-full h-full object-cover" />
            </div>
          </div>
          <div className="flex w-full sm:w-[33%] flex-row sm:flex-col gap-2 sm:gap-3">
            <div className="w-[45vw] sm:w-full h-48 sm:h-64 rounded-lg overflow-hidden">
              <img alt="img" src={images[3]} className="w-full h-full object-cover" />
            </div>
            <div className="w-[55vw] sm:w-full h-48 sm:h-80 rounded-lg overflow-hidden">
              <img alt="img" src={images[4]} className="w-full h-full object-cover" />
            </div>
          </div>
          <div className="flex w-full sm:w-[33%] flex-row sm:flex-col gap-2 sm:gap-3">
            <div className="w-[55vw] sm:w-full h-48 sm:h-80 rounded-lg overflow-hidden">
              <img alt="img" src={images[5]} className="w-full h-full object-cover" />
            </div>
            <div className="w-[45vw] sm:w-full h-48 sm:h-64 rounded-lg overflow-hidden">
              <img alt="img" src={images[6]} className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
