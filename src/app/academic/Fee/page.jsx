...
const FeeStructureTable = () => {
  ...
  const TableComponent = ({ data, title }) => (
    <>
      {title && (
        <h2 className="text-3xl font-bold mb-6 text-red-700 text-center">{title}</h2>
      )}
      <div className="overflow-hidden rounded-xl shadow-lg border border-gray-200 mb-8 bg-gray-50">
              ...
              >
                ...
                <td className="text-center px-6 py-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-red-700 text-white px-4 py-2 rounded-md hover:bg-red-900 transition-colors text-sm font-medium"
                  >
